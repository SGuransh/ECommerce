...
class OrderItem(models.Model):
    ...
    price= models.DecimalField(max_digits=7, decimal_places=2)
    image= models.CharField(max_length=200, null=True, blank=True)      # This is a url
    _id= models.AutoField(primary_key=True, editable=False)
...
class ShippingAddress(models.Model):
    order= models.OneToOneField(Order, on_delete=models.CASCADE)   # Can have only one order, CASCADE deletes the address if the order is deleted
